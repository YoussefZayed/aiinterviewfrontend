// base code from hackingbeuty https://github.com/hackingbeauty/react-mic/blob/master/src/components/ReactMic.js
...
export default class ReactMic extends Component {
    ...
    componentDidUpdate(prevProps) {
        const { record, onStop, microphoneId, getMicrophoneIds } = this.props;
        ...
        if (prevProps.microphoneId !== microphoneId) {
            if (microphoneRecorder) {
                microphoneRecorder.setMicrophoneDevice(microphoneId);
            }
        }
    }
        ...
        if (audioElem) {
            ...
            this.setState(
                ...
                () => {
                    this.visualize();
                    (async () => {
                        const microphoneDevices = await this.state.microphoneRecorder.getMicrophoneDevices();
                        getMicrophoneIds(microphoneDevices);
                    })();
                },
            );
        }
    ...
    render() {
        ...
        return <canvas ref={this.visualizerRef} height={height} width={width} className={this.props.className} />;
    }
}
